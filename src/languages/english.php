...
$LANG['alert_max_user_text'] = 'You have reached the maximum amount of user accounts (' . APP_MUSR . ') for TeamCal Neo Basic.';
$LANG['alert_max_user_help'] = 'Upgrade to the full version of TeamCal Neo to get unlimited user accounts.';
...
$LANG['users_max_reached'] = 'You have reached the maximum amount of user accounts ('.APP_MUSR.') for TeamCal Neo Basic. Upgrade to the TeamCal Neo full version to get unlimited user accounts.';
